...
| Document | For |
|---|---|
| `docs/IMPLEMENTATION_REPORT.md` | The team: what was built and why |
| `docs/PRESENTATION_BRIEF.md` | Presenting it, including likely questions |
...
The two write-ups are tracked as markdown so they can be read and diffed in the
browser. `gen_brief_pdf.py` typesets either one into a printable PDF.
...
python docs/gen_brief_pdf.py IMPLEMENTATION_REPORT.md "Implementation report" "subtitle"  # optional PDF
```
