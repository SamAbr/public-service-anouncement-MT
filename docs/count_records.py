...
U = pathlib.Path("/mnt/user-data/uploads/psa_generator")
...
bible = pd.read_csv(U / "output" / "bible_en_guz_swh.csv")
lg = pd.read_csv(U / "output" / "lughayangu_sentences.csv")
ke = pd.read_csv(HERE.parent / "psa_ke_train.csv").fillna("")
ket = pd.read_csv(HERE.parent / "psa_ke_test.csv").fillna("")
