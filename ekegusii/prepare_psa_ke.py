...
Merges and cleans the two professor-supplied Kenyan PSA corpora:
  ...
  * `output/PSA_KE_Final.csv`  - English / Kiswahili / Ekegusii / Dholuo / Somali
  * `output/_PSA_EnGuz.csv`    - English / Ekegusii, and a superset of the above
...
def main() -> int:
    ...
    ap.add_argument("--psa-ke", default=str(root / "output" / "PSA_KE_Final.csv"))
    ap.add_argument("--en-guz", default=str(root / "output" / "_PSA_EnGuz.csv"))
    ap.add_argument("--bible", default=str(root / "output" / "bible_en_guz_swh.csv"))
